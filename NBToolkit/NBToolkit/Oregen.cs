...
namespace NBToolkit
{
    ...
    public class Oregen : TKFilter
    {
        ...
        public void ApplyChunk (World world, Chunk chunk)
        {
            ...
            BlockManager bm = new GenOreBlockManager(world.GetBlockManager(), opt);
            ...
            for (int i = 0; i < opt.OPT_ROUNDS; i++) {
                ...
                int x = chunk.X * BlockManager.CHUNK_XLEN + rand.Next(BlockManager.CHUNK_XLEN);
                int y = (int)opt.OPT_MIN + rand.Next((int)opt.OPT_MAX - (int)opt.OPT_MIN);
                int z = chunk.Z * BlockManager.CHUNK_ZLEN + rand.Next(BlockManager.CHUNK_ZLEN);
    ...
    public class GenOreBlockManager : BlockManager
    {
        ...
        public GenOreBlockManager (BlockManager bm, OregenOptions o)
            : base(bm)
        {
            opt = o;
        }
